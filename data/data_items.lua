-- Item data tables for GogoLoot
-- This module contains item binding information and ignore lists

-- Helper function to convert value lists to key-based tables
...
-- Valid Bind-on-Pickup instances where trading is allowed
...
-- Internal ignore list - items that should never be auto-looted
...
-- Raid Quest Items and Materials
-- Default lookup table for raid quest items and materials
-- These items will be auto-assigned to designated player if configured
-- Priority: Check after ignore lists and item type checks, but BEFORE rarity-based distribution
GogoLoot.raidQuestItemsAndMaterials = valToKey(
    -- Molten Core (8 items)
...
-- Item bindings table
-- Values: 1 = Bind on Pickup, 4 = Quest item
itemBindings = {
    [60]=1,
    [61]=1,
    [79]=1,
